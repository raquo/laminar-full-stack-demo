...
object WaypointRoutingView {
  ...
  def apply(): HtmlElement = {
    div(
      ...
      hr(),
      p("So, first, we define the pages. Waypoint wants you to have a common Page trait, with individual pages expressed in GADT hierarchy. And yes, intermediate and marker traits are supported."),
